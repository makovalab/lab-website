...
Listen to the [Science Friday podcast](https://www.sciencefriday.com/segments/y-chromosome-fully-sequenced) where Adam Phillippy and [Kateryna Makova]({{< ref "/authors/kd-makova" >}}) discuss the challenges of sequencing the Y chromosome, and what doing so might mean for medical research.
...
[Kateryna Makova]({{< ref "/authors/kd-makova" >}}), the Verne M. Willaman Chair of Life Sciences, professor of biology and director of the Center for Medical Genomics, led Penn State's contributions to the study.

"The Y chromosome is by far the most difficult human chromosome to sequence and assemble," [Makova]({{< ref "/authors/kd-makova" >}}) said, explaining it is highly repetitive and is present in only one copy. "Deciphering its complete sequence is a major scientific milestone. My group has been working on the Y chromosome for over 20 years, and I did not think it would be possible to obtain its complete sequence in the near future."
...
"The complete sequence of the Y chromosome will provide scientists and physicians with critically missing information that will assist with diagnosing and treating important genetic disorders," [Makova]({{< ref "/authors/kd-makova" >}}) said. She also noted that the Y chromosome harbors several genes important for sperm production, and deletion of these genes has been associated with infertility disorders in males.
...
Co-authors from Penn State on this paper include [Robert Harris]({{< ref "/authors/rs-harris" >}}), assistant research professor of biology; [Paul Medvedev]({{< ref "/authors/p-medvedev" >}}), professor of computer science and engineering, and of biochemistry and molecular biology, and director of the Center for Computational Biology and Bioinformatics; [Marta Tomaszkiewicz]({{< ref "/authors/m-tomaszkiewicz" >}}), assistant research professor of biomedical engineering; [Allison Watwood]({{< ref "/authors/a-watwood" >}}), doctoral student in the Department of Biology; and [Matthias Weissensteiner]({{< ref "/authors/m-weissensteiner" >}}), postdoctoral research in the Department of Biology. The co-authors also included Penn State alumni — former doctoral students in the Makova Laboratory: [Monika Cechova]({{< ref "/authors/m-cechova" >}}), now a postdoctoral fellow at the University of California, Santa Cruz; [Arkarachai Fungtammasan]({{< ref "/authors/a-fungtammasan" >}}), now a researcher at DNA Nexus, and [Melissa Wilson]({{< ref "/authors/ma-wilson" >}}), now an associate professor at Arizona State University.
