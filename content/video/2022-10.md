...
[image]
  # The PSU Mediasite player publishes no thumbnail, so this is the lab's own
  # mitochondrial figure -- the lower half, which the project card does not use.
  filename = "video/2022-10.jpg"
  # Caption (optional)
  caption = ""
