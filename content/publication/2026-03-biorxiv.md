...
authors = ["P Hebbar", "TA Potapova", "H Loucks", "K Ray", "MF Rodrigues", "F Ryabov", "J Malukiewicz", "D Yoo", "LG de Lima", "A Haber", "S Kumar", "S Banerjee", "M Borchers", "GH Garcia", "J Gardner", "S Hachem", "HD Heath", "SK Ha", "M Mastoras", "B McNulty", "KM Munson", "K Pal", "JE Park", "S Plosch", "C Roos", "WE Seligmann", "V Shepelev", "C Spruce", "I Violich", "L Walter", "KD Makova", "A Thathiah", "SJS Rizzo", "AC Silva", "GW Carter", "KH Miga", "EE Eichler", "DF Conrad", "JL Gerton", "I Alexandrov", "B Paten"]
